...
public class SellerFormController implements Initializable {
	...
	//seta objeto department no atributo entity ( objeto vem do SellerListController )
    ...
    // Injeta objeto SellerService no Atributo Service .. chamado pelo DeparmentListController
	...
	private Seller getFormData() {
		...
		/*
		 * Comandos abaixo irão validar se campo Name do form Seller está vazio
	...
	//Qualquer classe que queira sre notificado da altreação da tabela Seller deverá impelmentar a interface
	//DatachangeListener
